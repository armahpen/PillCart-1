          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="text-center mt-8">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-900 font-semibold px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 border-2 border-white/20 ml-[-1px] mr-[-1px] pl-[34px] pr-[34px] mt-[-128px] mb-[-128px]"
              >
